...
sudo /bin/mount -t cifs //$NAME_MOUNT/dao_saisie$/01_DISTRIBUTION/OUVRAGES /home/sitadmin/sit/mount/ouvrages -o user=sitscripts,password=$PASS_MOUNT,dom=sige.ch,gid=1000,uid=1000
sudo /bin/mount -t cifs //$NAME_MOUNT/comm_tech_ro$ /home/sitadmin/sit/mount/comm_tech_ro -o user=sitscripts,password=$PASS_MOUNT,dom=sige.ch,gid=1000,uid=1000
