...
#TODO replace with new account (sitscripts) when ready :
#sudo /bin/mount -t cifs //$NAME_MOUNT/comm_tech_ro$ /home/sitadmin/sit/mount/comm_tech_ro -o user=infor,password=$PASS_MOUNT,dom=sige.ch,gid=1000,uid=1000
