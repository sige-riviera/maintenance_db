...
rsync -r -t -v --delete --size-only --omit-dir-times --times -u -s $SRCFOLDERPATH/CROQUIS $DESTFOLDERPATH/abonnes
rsync -r -t -v --delete --size-only --omit-dir-times --times -u -s $SRCFOLDERPATH/PHOTOS_ABTS $DESTFOLDERPATH/abonnes
