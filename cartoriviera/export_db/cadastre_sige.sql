...
create table usr_cartoriviera.sige_qgis_enquete_trace as select * from usr_cartoriviera.sige_qgis_enquete_trace_mn95;

create table usr_cartoriviera.sige_qgis_enquete_camac as select * from usr_cartoriviera.sige_qgis_enquete_camac_mn95;
create table usr_cartoriviera.sige_qgis_enquete_vs as select * from usr_cartoriviera.sige_qgis_enquete_vs_mn95;
...
alter table usr_cartoriviera.sige_qgis_enquete_trace alter column geometry type geometry('linestring', 21781) using st_geomfromewkb(st_fineltra(geometry, 'chenyx06.chenyx06_triangles', 'the_geom_lv95', 'the_geom_lv03'));
...
alter table usr_cartoriviera.sige_qgis_enquete_vs alter column geometry type geometry('point', 21781) using st_geomfromewkb(st_fineltra(geometry, 'chenyx06.chenyx06_triangles', 'the_geom_lv95', 'the_geom_lv03'));
