...
create table cartoriviera.sige_qgis_enquete as select * from cartoriviera.sige_qgis_enquete_mn95;
create table cartoriviera.sige_qgis_enquete_camac as select * from cartoriviera.sige_qgis_enquete_camac_mn95;
create table cartoriviera.sige_qgis_servitude_ligne as select * from cartoriviera.sige_qgis_servitude_ligne_mn95;
create table cartoriviera.sige_qgis_servitude_zone as select * from cartoriviera.sige_qgis_servitude_zone_mn95;
