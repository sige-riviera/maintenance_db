-- PGSERVICE=qwat_prod psql -v ON_ERROR_STOP=on -f cartoriviera/export_db/qwat_subscriber.sql
...
CREATE INDEX geoidx_sige_qgis_qwat_subscriber
ON usr_cartoriviera.sige_qgis_qwat_subscriber
USING gist (geometry);
