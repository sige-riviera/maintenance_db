...
ALTER TABLE usr_cartoriviera.sige_qgis_qgep_reach ALTER COLUMN progression_geometry TYPE Geometry(MultiLineStringZ, 21781) USING ST_GeomFromEWKB(ST_Fineltra(progression_geometry, 'chenyx06.chenyx06_triangles', 'the_geom_lv95', 'the_geom_lv03'));
