...
create table usr_cartoriviera.sige_qgis_qwat_printmap as select * from usr_cartoriviera.sige_qgis_qwat_printmap_mn95;

alter table usr_cartoriviera.sige_qgis_qwat_printmap alter column geometry type geometry('polygon', 21781) using st_geomfromewkb(st_fineltra(geometry, 'chenyx06.chenyx06_triangles', 'the_geom_lv95', 'the_geom_lv03'));
