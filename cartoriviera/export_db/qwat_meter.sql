...
drop table if exists usr_cartoriviera.sige_qgis_qwat_meter_mn95;

create table usr_cartoriviera.sige_qgis_qwat_meter_mn95 as
select
    id,
    fk_district,
    fk_pressurezone,
...
alter table usr_cartoriviera.sige_qgis_qwat_meter_mn95 alter column geometry type geometry('point', 2056) using st_force2d(geometry);

create table usr_cartoriviera.sige_qgis_qwat_meter as select * from usr_cartoriviera.sige_qgis_qwat_meter_mn95;

alter table usr_cartoriviera.sige_qgis_qwat_meter alter column geometry type geometry('point', 21781) using st_geomfromewkb(st_fineltra(geometry, 'chenyx06.chenyx06_triangles', 'the_geom_lv95', 'the_geom_lv03'));
