--PGSERVICE=qwat psql -v ON_ERROR_STOP=on -f ~/Documents/qgis/qwat-sige/export_cartoriviera/export_part.sql
...
-- part_type_value_en,
-- part_type_value_ro,
-- part_type_description_fr,
-- part_type_description_en,
-- part_type_description_ro,
...
alter table cartoriviera.sige_qgis_qwat_part_mn95 alter column geometry type geometry('point', 2056) using st_force2d(geometry);

create table cartoriviera.sige_qgis_qwat_part as select * from cartoriviera.sige_qgis_qwat_part_mn95;

alter table cartoriviera.sige_qgis_qwat_part alter column geometry type geometry('point', 21781) using st_geomfromewkb(st_fineltra(geometry, 'chenyx06.chenyx06_triangles', 'the_geom_lv95', 'the_geom_lv03'));

update cartoriviera.sige_qgis_qwat_part set
