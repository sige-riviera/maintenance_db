...
/usr/bin/pg_dump --host 172.24.173.216 --port 5432 --username "sige" --no-password  --format custom --verbose --file "/home/sige/maintenance_db/cartoriviera/export_db/qgep.backup" --schema "cartoriviera" "qgep_prod"
# Restore on sige_commun.cartoriviera
/usr/bin/pg_restore --host localhost --port 5432 --username "sige" --dbname "sige_commun" --no-password  --schema cartoriviera --verbose "/home/sige/maintenance_db/cartoriviera/export_db/qgep.backup"
...
/usr/bin/pg_dump --host localhost --port 5432 --username "sige" --no-password  --format custom --verbose --file "/home/sige/maintenance_db/cartoriviera/export_db/sige.backup" --schema "sige_qgis_cartoriviera" "sige_commun"
# /usr/bin/pg_dump --host localhost --port 5432 --username "sige" --no-password  --format plain --verbose --file "/home/rouzaudd/Documents/sige.sql" --schema "sige_qgis_cartoriviera" "sige_commun"
...
# mput /home/sige/maintenance_db/cartoriviera/export_db/qgis_project/*
# bye
# EOF
