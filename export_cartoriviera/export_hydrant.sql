...
drop table if exists cartoriviera.qwat_hydrant;

create table cartoriviera.qwat_hydrant as
select
    id,
    fk_district,
    fk_pressurezone,
...
alter table cartoriviera.qwat_hydrant alter column geometry type geometry('point', 21781) using st_force2d(st_geomfromewkb(st_fineltra(geometry, 'chenyx06.chenyx06_triangles', 'the_geom_lv95', 'the_geom_lv03')));

update cartoriviera.qwat_hydrant set
