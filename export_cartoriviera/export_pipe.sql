...
drop table if exists cartoriviera.qwat_pipe;

create table cartoriviera.qwat_pipe as
select
  id,
  fk_parent,
  fk_function,
...
alter table cartoriviera.qwat_pipe alter column geometry type geometry('linestring', 21781) using st_geomfromewkb(st_fineltra(geometry, 'chenyx06.chenyx06_triangles', 'the_geom_lv95', 'the_geom_lv03'));
